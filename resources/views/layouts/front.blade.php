            ...
            <div class="row s-header__navigation">
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    <ul class="s-header__nav">
                        ...
                        <li><a href="{{route('pages',['name'=>'styles'])}}" title="">Styles</a></li>
                        <li class="current-menu-item"><a href="{{route('pages',['name'=>'about'])}}" title="">About</a></li>
                        <li><a href="{{route('pages',['name'=>'contact'])}}" title="">Contact</a></li>
